...
const notas_ponto_d_sus_g_sus_21_8 = [
                                                "G#1", "A#1",
    "C2", "C#2", "D2", "D#2", "E2", "F2", "G2", "G#2", "A#2",
    "C3",
...
const notas_ponto_e_a_21_8 = [
                                                  "A1", "B1",
    "C#2", "D2", "D#2", "E2", "F2", "F#2", "G#2", "A2", "B3",
    "C#3",
...
const notas_ponto_f_sus_b_21_8 = [
                                                         "B1",
    "C#2", "D#2", "E2", "F2", "F#2", "G2", "G#2", "A#2", "B2",
    "C#3", "D#3",
...
const notas_ponto_b_e_21_8 = [
                        "E2", "F#2", "G#2", "A2", "A#2", "B2",
    "C3", "C#3", "D#3", "E3", "F#3", "G#3",
